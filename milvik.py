...
print("")
time.sleep(3.0)
print("How are you ? I am sure you are doing fine !!")
print("")
time.sleep(3.0)
print("Let me tell you brief history of MILVIK...")
print("")
time.sleep(3.0)
print("through the most awkward animations possible !!")
print(emoji.emojize(":winking_face_with_tongue:"))
print("")
time.sleep(3.0)
print("I hope you are ready for this !!")
print("")
time.sleep(5.0)
print("")
print("")
...
print("Pandemic made people reasalise the importance of BIMA even more. Insurance and health service should never be luxury but rather a necessary that each and everyone can afford. And we at BIMA primose to work hard in delivering towards that goal")
print("")
print("")
print("")
print("")
...
print("")
print("")
print("Found the animations interesting ?")
print("")
...
print("")
print("")
print("Thanks for sitting through these awkward animations !!")
print("")
print("")
print("")
print("")
